...
public class PremiumCar extends Car {
    ...
    public double calculatePrice(double km) { double startFee = 15.0; return startFee + ((this.getPricePerKm() + this.luxuryTax) * km); }
    public String toString() { return super.toString() + " [LUXURY TAX: " + luxuryTax + "]"; }
}